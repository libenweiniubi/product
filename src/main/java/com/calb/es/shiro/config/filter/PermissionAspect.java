package com.calb.es.shiro.config.filter;

import com.calb.es.shiro.config.annotation.Logical;
import com.calb.es.shiro.config.annotation.RequiresPermissions;
import com.calb.es.shiro.config.exception.UnauthorizedException;
import com.calb.es.shiro.service.TokenService;
...
public class PermissionAspect {
    ...
    @Before("@annotation(com.calb.es.shiro.config.annotation.RequiresPermissions)")
